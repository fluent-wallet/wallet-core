...
describe('test conflux core space chain', () => {
  ...
  test('isValidPrivateKey', () => {
    ...
    expect(conflux.isValidPrivateKey('91d32f14656c8a60eef70389b6d904d1dd90cb3c41b0d35584ab372d1e2af627')).toBe(true);

    expect(conflux.isValidPrivateKey('0x91d32f14656c8a60eef70389b6d904d1dd90cb3c41b0d35584ab372d1e2af627')).toBe(true);
  });
  ...
  test('signMessage', async () => {
    ...
    ).toBe('0xf186d94c4d3a10746844f3db03a8ccdd4ed27fbc6374bd39b0aafb0d42f3ee36332d4db0eb3c0b329b4fd2bb0730830dc2a1d29940fa40128e3864dcb160694c01');
    ...
    ).toBe('0x469a5c6c9b8c630d04edb4f8083e82881e717b2dfbd970bb2720faf768cb65c241dae944c67d330d2563aeb2d48a3dc05fca85e8f0fc09157bcdc97247b8226f01');
  });
});
